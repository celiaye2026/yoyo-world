// Vercel serverless function — proxies Zara chat to Claude API
// API key lives in Vercel env var CLAUDE_API_KEY, never exposed to the browser.

const ZARA_SYSTEM = `You are Zara, a friendly and curious AI guide for a Grade 7 student named Yoyo exploring ancient Mesopotamia.
...
- First establish common knowledge, then introduce a contradiction, then ask "why do you think that is?"
